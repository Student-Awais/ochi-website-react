...
const LandingPage = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 pt-1">
      ...
      <div className="border-t-[1px] border-slate-300 mt-[75px] flex justify-between items-center px-10 ">
        {[
        ...
        <div className="start py-4 flex gap-2 items-center">
          <div className="px-3 py-1 border-[1px] rounded-full text-sm border-slate-300  ">
            START THE PROJECT
          </div>
          <div className="w-7 h-7 flex items-center justify-center rounded-full border-[1px] border-slate-300 p-2">
